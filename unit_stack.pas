...
//  stackmenu1.reference_database1.items[0]:='Local database '+ star_database1.text;
  ...
  stackmenu1.reference_database1.Items.BeginUpdate;
  try
    stackmenu1.reference_database1.Items.Strings[0] :='Local database '+ star_database1.text;
  finally
    stackmenu1.reference_database1.Items.EndUpdate;
  end;
