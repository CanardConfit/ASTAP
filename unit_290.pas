...
begin
  ...
  if uppercase(copy(database,1,1))<>'H' then
  begin
    if fileexists( database_path+database+'_0101.290') then begin name_star:=database; {try preference}exit; end
  end
  else
  begin
    if fileexists( database_path+database+'_0101.1476') then begin name_star:=database; {try preference} file290:=false; exit; end;
  end;

  if fileexists( database_path+'h18_0101.1476') then begin name_star:='h18'; file290:=false; end
  else
...
begin
  ...
  begin
    ...
    if file290 then
      name_star:=copy(name_star,1,3)+'_'+filenames290[area290] {g17_0101.290}
    else
      name_star:=copy(name_star,1,3)+'_'+filenames1476[area290]; {g17_0101.1476}
