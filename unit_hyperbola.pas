...
function scaled_error_hyperbola(data: array of TDouble2 {pos, hfd};data_length:integer; perfectfocusposition,a,b,seeing_limit: double): double;{calculates total squared error between measured V-curve and hyperbola with hyperbola lowest values clamped against seeing limit}
var
  n, i: Integer;
