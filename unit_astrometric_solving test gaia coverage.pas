            ...
            begin
             ...
             oversize:=1;
              ...
              repeat {loop to add extra stars if too many too small quads are excluding. Note the database is made by a space telescope with a resolution exceeding all earth telescopes}
                ...
                if read_stars(telescope_ra,telescope_dec,0.25*pi/180{    search_field} *oversize,round(nrstars_required*oversize*oversize*extrastars) ,{var}database_stars)= false then
                begin
              ...
              until ((nrstars_required>database_stars) {No more stars available in the database}
                      ...
                      or (extrastars>1)) {Go up this factor maximum};
//              or (extrastars>15)) {Go up this factor maximum};
          ...
          if ((telescope_dec<1.5) and ((telescope_dec>-1.5)) and (database_stars>0)) then
          begin
  ...
  memo2_message('results: ' +inttostr(toolittle)+',    '+inttostr(good));
