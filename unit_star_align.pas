...
procedure find_quads_old(starlist :star_list; min_leng:double; out quad_smallest:double; out quad_star_distances :star_list);  {build quads using closest stars, revised 2022-3-13}
var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          distance:=distx + sqr(starlist[1,j]-starlist[1,i]);{square distances are used}
          if distance>1 then {not an identical star. Mod 2021-6-25}
          begin
            if distance<distance1 then
            begin
